            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                    echo "<pre>".shell_exec("sudo echo \"49 10  * * * sudo ssh -p 2222 root@192.168.0.100 'sh -s' < /var/www/html/ESXi-Web-Management-Tool/scripts/BackupSingleVM.sh 10\" | crontab -")."/<pre>";
