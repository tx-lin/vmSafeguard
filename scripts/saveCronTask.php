...
<head>
  ...
  <title>EWMT | Summary Section</title>
  <!-- plugins:css -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    ...
                    <?php
                    echo "<pre>".shell_exec("sudo echo \"".htmlspecialchars($_POST['min'])." ".htmlspecialchars($_POST['hour'])." ".htmlspecialchars($_POST['dayOfMonth'])." ".htmlspecialchars($_POST['month'])." ".htmlspecialchars($_POST['dayOfWeek'])." sudo ssh -p $PORT root@$HOST 'sh -s' < /var/www/html/ESXi-Web-Management-Tool/scripts/PoolVMBackup.sh &\" | crontab -")."/<pre>";
