...
sudo chown -R www-data:www-data /var/www/html/ESXi-Web-Management-Tool # seulement l'utilisateur www:data et son grp aura des droits RWX, pour exec les scripts.php / ewmt.db
